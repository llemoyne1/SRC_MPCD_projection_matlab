function out = mpcd_incompressible_simulator(params, x, v, type, r0)
...
out.redistDiag = redistDiag; out.redistribStats = redistribStats; out.wallDiag = wallDiag; out.pressureDiag = pressureDiag;
...
out.series = struct('E',E,'occStd',occStd,'outBand',outBand,'redistDiag',redistDiag,'redistribStats',redistribStats, ...
    'wallDiag',wallDiag,'pressureDiag',pressureDiag,'msdAll',msdAll,'msdType0',msdType0,'msdType1',msdType1, ...
