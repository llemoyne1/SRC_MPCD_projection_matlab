...
if isfield(stateClassic, 'piston') && isstruct(stateClassic.piston)
    pistonInfo.workOnFluidCumulative = getf(stateClassic.piston, 'workOnFluidCumulative', NaN);
    pistonInfo.lastWorkIncrement = getf(stateClassic.piston, 'lastWorkIncrement', NaN);
    pistonInfo.lastPowerOnFluid = getf(stateClassic.piston, 'lastPowerOnFluid', NaN);
end
