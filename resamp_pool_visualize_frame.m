...
roleInfoTitle = resamp_particle_role_mask(state);
sgtitle(sprintf(['%s step %d, t=%.4g %s | Nact=%d/%d free=%d latent=%d extractNow=%s extCum=%s extLast=%s ', ...
    ...
    md.NpActive, md.Ncapacity, md.Nfree, roleInfoTitle.nLatent, ...
