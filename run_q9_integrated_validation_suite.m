...
results = run_q9_poiseuille_wall_virtual_particles_validation( ...
    ...
    'massFluxProjectionOperator', opts.poiseuilleMassFluxProjectionOperator, ...
    'massFluxTargetFilter', opts.poiseuilleMassFluxTargetFilter, ...
    'massFluxFinalVelocityProjectionCleanup', opts.poiseuilleMassFluxFinalVelocityProjectionCleanup);
...
opts.poiseuilleMassFluxProjectionOperator = 'general_bc';
opts.poiseuilleMassFluxTargetFilter = 'elliptic_lowpass';
opts.poiseuilleMassFluxFinalVelocityProjectionCleanup = false;
