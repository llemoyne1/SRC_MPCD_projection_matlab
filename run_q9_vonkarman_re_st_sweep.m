...
% measured mean Ux from the run.
% caseName = strings(4,1);
% U0 = zeros(4,1);
% bodyForceX = zeros(4,1);
% R = zeros(4,1);
% 
% caseName(1) = "baseline";     U0(1) = 0.08; bodyForceX(1) = 0.02; R(1) = 0.10 * base.Ly;
% caseName(2) = "higher_U";     U0(2) = 0.12; bodyForceX(2) = 0.02; R(2) = 0.10 * base.Ly;
% caseName(3) = "larger_D";     U0(3) = 0.08; bodyForceX(3) = 0.02; R(3) = 0.14 * base.Ly;
% caseName(4) = "higher_U_D";   U0(4) = 0.12; bodyForceX(4) = 0.02; R(4) = 0.14 * base.Ly;
...
for ic = 1:nCases
    ...
    try
        ...
        outList{ic} = out;
        s = out.summary;
        rows{ic} = table(caseName(ic), params.nSteps, params.seed, params.Nx, params.Ny, params.gamma, ...
            ...
            'VariableNames', {'caseName','nSteps','seed','Nx','Ny','gamma', ...
...
T = table(caseName, base.nSteps, base.seed, base.Nx, base.Ny, base.gamma, ...
